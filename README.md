...
<br>
Напрямую пользователь общается только с сервисами <b>auth</b> и <b>gateway</b> и ничего не знает о существовании других сервисов. 
В то время как микросервисы - ничего не знают об аутентификационных данных пользователя, ведь они общаются только с <b>gateway-сервисом</b>, 
