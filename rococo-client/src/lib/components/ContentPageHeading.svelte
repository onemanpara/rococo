...
<div class="flex items-center justify-between m-4">
    ...
    {#if $sessionStore.user}
        <button type="button" class="btn variant-filled-primary ml-4" data-testid="addNewItemButton" on:click={onAddButtonClick}>{addButtonName}</button>
    {/if}
</div>
...
<div class="flex justify-center mb-4 mx-8" data-testid="searchComponent">
    ...
    <button type="button" class="btn-icon variant-soft-surface ml-4" data-testid="searchButton" on:click={() => loadFunction(search)}>
